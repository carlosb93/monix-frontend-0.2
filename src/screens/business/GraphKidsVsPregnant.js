...
export default class GraphKidsVsPregnant extends React.Component {
...
render() { 
  ...
  >
     <Image
                  ...
                  <Text style={{ color: COLORS.white, ...FONTS.h2 }}>   Niños Vs Embarazadas  </Text>
                  <TouchableOpacity
