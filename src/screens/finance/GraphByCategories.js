...
export default class GraphByCategories extends React.Component {
...
processCategoryDataToDisplay = async () => {
    ...
    let chartData = this.state.categories.map((item) => {
        let confirmExpenses = item.expenses.filter(a => a.isPositive == false)
...
render() { 
  ...
  >
     <Image
                  ...
                  <Text style={{ color: COLORS.white, ...FONTS.h2 }}>   Gastos Balance por Categorias </Text>
                  <TouchableOpacity
  ...
  >
      ...
      <VictoryPie
                    ...
                    <View style={{ position: 'absolute', top: '42%', left: "42%" }}>
                        ...
                        <Text style={{ ...FONTS.body3, textAlign: 'center' }}>Gastos</Text>
                    </View>
                </View>
      ...
      <View style={{ padding: SIZES.padding }}>
                <FlatList
                  ...
                  >
                    ...
                    <Text style={{ color: (this.state.selectedCategory && this.state.selectedCategory.name == item.name) ? COLORS.white : COLORS.peach, ...FONTS.h4 }}>{item.name}   - { Numeral(item.y).format('0,0.00')} CUP - {item.label}</Text>
                </View>
                  </TouchableOpacity>)}
