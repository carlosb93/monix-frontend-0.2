      ...
      <View style={{ padding: SIZES.padding }}>
                <FlatList
                  ...
                  >
                    ...
                    <Text style={{ color: (this.state.selectedCategory && this.state.selectedCategory.name == item.name) ? COLORS.white : COLORS.peach, ...FONTS.h4 }}>{item.name}   - {item.y} CUP - {item.label}</Text>
                </View>
                  </TouchableOpacity>)}
