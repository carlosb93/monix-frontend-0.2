                    ...
                    >
                        <TouchableOpacity
                            style={{
                                ...
                                backgroundColor: this.state.selectedBlue == 5 ? this.state.ColorPicker : COLORS.softgray,
                                alignItems: 'center',
                                justifyContent: 'center',
                    ...
                    >
                        <TouchableOpacity
                            style={{
                                ...
                                height: SIZES.width * 0.1,
                                padding: SIZES.padding,
                                backgroundColor: this.state.selectedGreen == 5 ? this.state.ColorPicker : COLORS.softgray,
                                alignItems: 'center',
                                justifyContent: 'center',
                                borderRadius: SIZES.radius,
                    ...
                    >
                        <TouchableOpacity
                            style={{
                                ...
                                height: SIZES.width * 0.1,
                                padding: SIZES.padding,
                                backgroundColor: this.state.selectedyellow == 5 ? this.state.ColorPicker : COLORS.softgray,
                                alignItems: 'center',
                                justifyContent: 'center',
                                borderRadius: SIZES.radius,
                    ...
                    >
                        <TouchableOpacity
                            style={{
                                ...
                                height: SIZES.width * 0.1,
                                padding: SIZES.padding,
                                backgroundColor:  this.state.selectedPeach == 5 ? this.state.ColorPicker : COLORS.softgray,
                                alignItems: 'center',
                                justifyContent: 'center',
                                borderRadius: SIZES.radius,
                    ...
                    >
                        <TouchableOpacity
                            style={{
                                ...
                                height: SIZES.width * 0.1,
                                padding: SIZES.padding,
                                backgroundColor: this.state.selectedPurple == 5 ? this.state.ColorPicker : COLORS.softgray,
                                alignItems: 'center',
                                justifyContent: 'center',
                                borderRadius: SIZES.radius,
